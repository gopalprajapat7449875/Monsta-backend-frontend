...
export default function UpdateSlider() {
    ...
    let Addslider = (e) => {
        ...
        console.log(data)
        axios.put(`${apibaseurl}slider/update/${_id}`, data)
            .then((res) => res.data)
            .then((finalres) => {
    ...
    useEffect(() => {
        ...
        axios.get(`${apibaseurl}slider/updatedata/${_id}`)
            .then((res) => {
    ...
    return (
        <>
            ...
            <div className=' w-5xl mx-auto min-h-[88vh]'>
                <h2 className='ps-3 py-2'>Home/UpdateSlider</h2>

                <div className='shadow p-2 w-5xl mx-auto bg-neutral-100'>
                    <div className='shadow-xs shadow-violet-600 '> <h2 className='shadow-violet-900 text-2xl font-bold px-3 py-1 text-neutral-600'> Update Slider</h2>  </div>
                    <form action="submit" onSubmit={Addslider}>
                        <div className='grid grid-cols-3'>

                            <div className='col-span-2'>

                                <div className='flex flex-col mx-2 my-4 gap-2 text-[18px ] font-bold'>
                                    <label htmlFor="Name" > Slider Title </label>
                                    <input type="text" defaultValue={sliderdata._SliderTitle} name='_SliderTitle' placeholder='Enter Slider Title ' className='w-xl px-2 py-2 border border-violet-300 bg-white outline-none rounded' />
                                </div>

                                <div className='flex flex-col mx-2 my-4 gap-2 text-[18px ] font-bold'>
                                    <label htmlFor="Name" > Slider  order </label>
                                    <input type="number" name='_SliderOrder' defaultValue={sliderdata._SliderOrder} placeholder='Enter order ' className='w-xl px-2 py-2 border border-violet-300 bg-white outline-none rounded' />
                                </div>
