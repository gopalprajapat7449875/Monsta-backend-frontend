  ...
  return (
    <>
      ...
      <div className=' w-5xl mx-auto min-h-[88vh]'>
        <h2 className='ps-3 py-2'>Home/Meterial/AddMeterial</h2>
          ...
          <div className=''>
            ...
            <form action="submit" onSubmit={AddColor}>
              <div className='flex flex-col mx-2 my-4 gap-2 text-[18px ] font-bold'>
                ...
                <input name='_MetarialName' placeholder='Enter Material Name' type="text" className='w-xl px-2 py-2 border border-violet-300  bg-white outline-none rounded' />

              </div>
              <div className='flex flex-col mx-2 my-4 gap-2 text-[18px ] font-bold'>
                <label htmlFor="Name" > Meterial Code </label>
                <input name='_MetarialCode' type="text" placeholder='Enter Code' className='w-xl px-2 py-2 border border-violet-300 bg-white outline-none rounded' />
              </div>

              <div className='flex flex-col mx-2 my-4 gap-2 text-[18px ] font-bold'>
                <label htmlFor="Name" >  order </label>
                <input name='_MetarialOrder' type="number" placeholder='Enter order ' className='w-xl px-2 py-2 border border-violet-300 bg-white outline-none rounded' />
              </div>
