    ...
    <div className=' w-5xl mx-auto min-h-[88vh]'>
             ...
             <div className='py-2 px-8 flex justify-between p'>
               <button className='px-5 bg-violet-300 rounded py-2 text-shadow-white '>
                ...
                <div className="App">
    <div className="box text-red-800 w-20 h-20 font-bold rounded-full shadow-2xs border-2  shadow-fuchsia-700 duration-200 flex justify-center items-center" ref={boxRef}>Hello</div>
  </div>
               <label for="points">   </label>
               <input type="range" id="points" name="points" min="100" max="10000"/>
                 ...
                 <table className="w-full border border-gray-300">
                   <thead className="bg-gray-200">
                     <tr>
                       ...
                       <th className="border p-2">User Info.</th>
                   ...
                   <tbody>
                     ...
                     <tr className="text-center">
                       ...
                       <td className="border p-2">Somiya</td>
                       <td className="border p-2">somiyasoni@gmail.com</td>
                       <td className="border p-2">6589754845</td>
