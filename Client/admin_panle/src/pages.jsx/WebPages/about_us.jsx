...
<>
    <div className=' w-5xl mx-auto min-h-[88vh]'>
             <h2 className='ps-3 py-2'>Home/Web-Pages/About-Us/View</h2>
             ...
             <div className='shadow p-2 w-5xl mx-auto bg-neutral-100'>
               ...
               <div className='shadow-xs shadow-violet-600 '> <h2 className='shadow-violet-900 text-2xl font-bold px-3 py-1 text-neutral-600'>View About-Us</h2>  </div>
